        ...
        public function exportCsv(Request $request){
           ...
           //exit;
            ...
            if (file_exists( public_path() . '/storage/temp_json/'.$request->project_id.'_'.$csv_counter_prv.'_'.$user->name.'.json'))
            {
                ...
                $exact_path_json = public_path('storage/json/'.$request->project_id.'_'.$csv_counter_prv.'_'.$user->name.'');
                ...
                $exact_path_json = public_path('storage/json/'.$request->project_id.'_'.$csv_counter.'_'.$user->name.'');
                File::put(public_path('/storage/temp_json/'.$fileName_json), json_encode($data_json));
