...
@can('user_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a  type="button"  class="w3-btn w3-green" href="/admin/show-plot-type">  Add </a>
        </div>
    </div>
@endcan
                           ...
                           <td>
                                 @can('user_edit')
                                  ...
                                  <!--  <button class="w3-btn w3-blue edit_plot" value="{{$datas->id}}" style="position:relative;left: 5px;"><i class="nav-icon fas fa-edit"></i></button> -->
                                    <form  action="/admin/edit-plot/{{$datas->id_plot}}" enctype="multipart/form-data">
                                        <input type="hidden" name="id" value="{{$datas->id_plot}}">
