...
@section('content')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12" >
            <a class="nav-link" href="{{ url("admin/add-plot-window") }} "><button  type="button"  class="w3-btn w3-green"  >  Add </button> </a>
        </div>
    </div>
                   ...
                   @foreach($data as $key => $datas)
                        <tr>
                           ...
                           <td>
                                    ...
                                    <form  action="/admin/edit-plot-window/{{$datas->user_plote_id}}" enctype="multipart/form-data">
                                        <input type="hidden" name="id" value="{{$datas->user_plote_id}}">
                                    ...
                                    <button class="btn btn-danger delete_plot" plottype="{{$datas->user_plote_id}}" style="position:relative;left: 10px" ><i class="nav-icon fas fa-trash"></i></button>
                                     <!--<button class="btn btn-danger delete_plot" plottype="{{$datas->user_plote_id}}" style="position:relative;left: 10px" ><i class="nav-icon fas fa-trash"></i></button>-->
