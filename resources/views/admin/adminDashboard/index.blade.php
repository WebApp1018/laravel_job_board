                ...
                <div class="col-md-12">
                    <div class="card strpied-tabled-with-hover">
                        <div class="card-header ">
                            <h4 class="card-title"><strong>All Users Projects List</strong></h4>
                        </div>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($allProject as $project)
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ substr($project->description ?? '', 0, 60) }}...</button>
                                            </td>
                                            <td>

                                                <a href="/admin/project-trees/{{ $project->id }}/{{ $p_revision_id }}"
                                                    class="w3-btn w3-blue" style="position:relative;left: 5px;"> <i
                                                        class="nav-icon fa fa-eye"></i></a>

                                                <button class="btn btn-danger delete_pro" ids="{{ $project->id }}"
        ...
        <div class="w3-modal-content w3-card-8 w3-animate-zoom" style="max-width:600px">
            ...
            <div class="w3-container">
                <div class="w3-section">
                    ...
                    <form role="form" id="category" method="POST" action="{{ route('admin.add.project') }}"
                        enctype="multipart/form-data">
                        @csrf
                        <div style="width: 85%;margin: auto;">
                            <label><b>Project Name</b></label>
                            <div class="form-group {{ $errors->has('title') ? 'has-error' : '' }}">
                                <input class="form-control" type="text" name="project_name" placeholder="Create Project"
                            ...
                            <div class="form-group {{ $errors->has('title') ? 'has-error' : '' }}">
                                <textarea class="form-control" type="text" name="description" id="description" placeholder="description..."
                                    required="" rows="6" cols="50"></textarea>
                            </div>
                            ...
                            <button type="button" class="w3-btn w3-green" id="update_project"
                                style="width: 48%;position: relative;left:20px;display:none"> update Project</button>
                        </div>
