        ...
        <div>
            <form style="" method="post">
               ...
               <input type="hidden" id="floor_number" name="floor_number" value="0">
                          ...
                          <p class="p5">
                                <div class="custom-control custom-switch d-flex align-items-center">
                                    ...
                                    <div class="toggle-btn ml-2">
                                        <input type="checkbox" class="" name="roof" id="addRoof"/>
                                        <label></label>
                                    </div>
                                </div>
                            </p>
                ...
                <div class="con floor" style="display:none;">
                        ...
                        <div >
                            ...
                            <div class="p6" >
                                <svg class="remove removeextRooms${count}"  xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" class="bi bi-trash-fill" viewBox="0 0 16 16">
                                 ...
                                 <input type="hidden" name="groundFloor[]" value="${count}">   
...
$("#addBasement").click(function(){
    let count =  $('#basement-floor').attr("data-basement");
        count = parseInt(count)+1;
        $("#basement-floor").append(`
        <section >
                <div >
                    <section class="basement${count}">
                        <div class="p6" >
                            <svg class="remove remove-basement${count}"  xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" class="bi bi-trash-fill" viewBox="0 0 16 16">
                                <path d="M2.5 1a1 1 0 0 0-1 1v1a1 1 0 0 0 1 1H3v9a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2V4h.5a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1H10a1 1 0 0 0-1-1H7a1 1 0 0 0-1 1H2.5zm3 4a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-1 0v-7a.5.5 0 0 1 .5-.5zM8 5a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-1 0v-7A.5.5 0 0 1 8 5zm3 .5v7a.5.5 0 0 1-1 0v-7a.5.5 0 0 1 1 0z" />
                            </svg>
                                <input type="hidden" name="basement[]" value="${count}">   
                            <span class="ms-3">Floor-${count}</span>
                        </div>
                    </section>
                </div>
    ...
    $(`.remove-basement${count}`).on('click', function () {
