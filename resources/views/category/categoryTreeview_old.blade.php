 ...
 .modal-dialog .modal-dialog-centered{
   ...
   <body class="app header-fixed sidebar-fixed aside-menu-fixed pace-done sidebar-lg-show">
                  ...
                  <div class="navbar-collapse justify-content-end" id="navigation">
                     ...
                     <li class="dropdown nav-item">
                        ...
                        <form action="{{url('admin/exportCsv2')}}" action="post">
                           ...
                           <input type="hidden" id="project_revision_id2" name="project_revision_id" value="{{request()->segment(4)}}">
                           <input type="hidden" id="revesion_id" name="revesion_id" value="{{ '/'.$segment_users."_".$csv_counter.'_'.$u_name.'.csv' }}">
                           <span class="nav-link p-0">

                                @if(file_exists( public_path() . '/'.$sitesettings->csvfilepath.'/'.$segment_users."_".$csv_counter.'_'.$u_name.'.csv')) 
                                    <button class="btn btn-success downloadcsv " type="submit" >Csv File Download</button>
                                @else
                                <button class="btn btn-secondary" type="button" >Csv File Download</button>
                                @endif
                     ...
                     <li class="dropdown nav-item">
                        ...
                        <form action="{{url('admin/exportJson2')}}" action="post">
                           ...
                           <input type="hidden" name="project_id" value="{{$segment_users}}">
                           <input type="hidden" id="project_revision_id2" name="project_revision_id" value="{{request()->segment(4)}}">
                           <input type="hidden" id="revesion_id_json" name="revesion_id" value="{{ '/'.$segment_users."_".$csv_counter.'_'.$u_name.'.json' }}">
                           <span class="nav-link p-0">
                            @if(file_exists( public_path() . '/'.$sitesettings->jsonfilepath.'/'.$segment_users."_".$csv_counter.'_'.$u_name.'.json')) 

                                <button class="btn btn-success downloadjson " type="submit" >Json File Download</button>
                            @else
                                <button class="btn btn-secondary " type="button" >Json File Download</button>
                           @endif  
                        </span>
                        </form>
                        @endif
                     ...
                     <li class="dropdown nav-item" style="list-style: none;">
                        <a href="{{ route('admin.add.plot.window') }}"  class="btn btn-secondary error_message" > Add Plot</a>
                    </li>
                     <li class="dropdown nav-item" style="list-style: none;">
                      <?php 
                      $file_name =  request()->segment(3).'_'.$csv_counter.'_'.$u_name.'.pdf';
                      if (file_exists( public_path() . '/'.$sitesettings->pdffilepath.'/'.$file_name)) { ?>
                      <a href="{{ asset(''.$sitesettings->pdffilepath.'/'.$file_name) }}" target="_blank" download  class="btn btn-success" ><i class="fa fa-download"></i> PDF Download</a>
                      <?php } 
                      else
                      {
                        ?>
                        <a href="#"  class="btn btn-secondary error_message" ><i class="fa fa-download"></i> PDF Download</a>
                        <?php 
                      }
                      ?>
                       <!--  <span class="nav-link">
                     ...
                     <li class="dropdown nav-item" style="list-style: none;">
                      ...
                      <a href="{{ asset(''.$sitesettings->fbxfilepath.'/'.$file_name) }}" target="_blank" download  class="btn btn-success" ><i class="fa fa-download"></i> FBX Download</a>
                      <?php } 
                      else
                      {
                        ?>
                        
                        <a href="#"   class="btn btn-secondary error_message" ><i class="fa fa-download"></i> FBX Download</a>
                        <?php 
                      }
                      ?>
                     </li>
                     <li class="dropdown nav-item" style="list-style: none;">
                      ...
                      <a href="{{ asset(''.$sitesettings->dwgfilepath.'/'.$file_name) }}" target="_blank" download  class="btn btn-success" ><i class="fa fa-download"></i> DWG Download</a>
                      <?php } 
                      else
                      {
                        ?>
                        
                        <a href="#"  class="btn btn-secondary error_message" ><i class="fa fa-download"></i> DWG Download</a>
                        <?php 
                      }
                      ?>
                     </li>
                     ...
                     */ ?>
                     ...
                     <li class="nav-item">
                        {{-- <a href="/admin/3d-view-model" class="nav-link"> --}}
                            ...
                            @if(file_exists( public_path() . '/'.$sitesettings->fbxfilepath.'/'.$segment_users."_".$csv_counter.'_'.$u_name.'.fbx'))

                                <button  onclick="viewm_model(this)" data-id="model=/{{ $sitesettings->fbxfilepath }}/{{ $segment_users."_".$csv_counter.'_'.$u_name.'.fbx'  }}" class="btn btn-success" >3D view</button>
                            @elseif(file_exists( public_path() . '/'.$sitesettings->dwgfilepath.'/'.$segment_users."_".$csv_counter.'_'.$u_name.'.dwg'))
                            <button  onclick="viewm_model(this)" data-id="model=/{{ $sitesettings->dwgfilepath }}/{{ $segment_users."_".$csv_counter.'_'.$u_name.'.dwg'  }}" class="btn btn-success" >3D view</button>
                            @else 
                            <button   data-id="model=/{{ $sitesettings->dwgfilepath }}/{{ $segment_users."_".$csv_counter.'_'.$u_name.'.fbx'  }}" class="btn btn-secondary" >3D view</button>
                            @endif
                        {{-- </a> --}}
                     </li>
                     </ul>
                ...
                <div class="w3-modal-content" id="w3-modal-content" style="height: 500px">
                    <div class="w3-container" id="w3-container" style="height: 100%">
                      ...
                      <div class="card"  style="height: 100%">
                        <h1>3D Viewer</h1>
                        <span onclick="document.getElementById('room_model_new').style.display='none'" id="close"  class="w3-button w3-display-topright">&times;</span>
                          <div id="iframemodel" style="
                          width: 100%;
                          height:100%;
                          margin: auto;
                      ">
    ...
    <script>
            ...
            $('#iframemodel').html('<iframe    style="height: 100%;  width:100%" src="{{  route("admin.3dnewviewer") }}?sidebar={{ $sitesettings->sidebar }}&navigationlist={{ $sitesettings->navigationlist }}&dpanel={{ $sitesettings->dpanel }}&sidebartwo={{ $sitesettings->sidebartwo }}#'+$(s).data('id')+'"></iframe>');
                     ...
                     <div class="row">
                        <div class="col-md-12">
                           <div class="card">
                              <div class="card-header">
                                <div class="lockicon">
                                    ...
                                    font-size: 28px;
                                    @if($project->is_locked!='Yes')  display:none;  @endif
                                "></i>
                         ...
                         "></i>
                              ...
                              <div class="alert alert-danger alert-dismissible fade show w-75 mx-auto my-2" role="alert">
                              ...
                              <div class="csv_file_selectbox d-none" style="width: 100%;margin-left: 1%">
                                 ...
                                 <div class="" style="margin-top: 2%;">
                                    ...
                                    <button onclick="copyToClipboard('#p1')" class="btn btn-primary copy_json">Copy CSV file path</button>
                                    <?php } else
                                    {
                                       ?>
                                       <button class="btn btn-primary copy_json error_message">Copy CSV file path</button>
                                       <?php
                                    }
                                    $file_name =  request()->segment(3).'_'.$csv_counter.'_'.$u_name.'.json';
                                    if (file_exists( public_path() . '/'.$sitesettings->jsonfilepath.'/'.$file_name)) { ?>
                                    <button onclick="copyToClipboard2('#p2')" class="btn btn-primary copy_json">Copy Json file path</button>
                                    <?php } else
                                    {
                                       ?>
                                       <button class="btn btn-primary copy_json error_message">Copy Json file path</button>
                                       <?php
                                    } ?>
                                    @endif
                                    @if($u_id!=1 || $u_id==1)
                                    ...
                                    <button onclick="copyToClipboard3('#p3')" class="btn btn-primary ">Copy PDF file path</button>
                                    <?php } else
                                    {
                                       ?>
                                       <button class="btn btn-primary copy_json error_message">Copy PDF file path</button>
                                       <?php
                                    } 
                                    $file_name =  request()->segment(3).'_'.$csv_counter.'_'.$u_name.'.fbx';
                                    if (file_exists( public_path() . '/'.$sitesettings->fbxfilepath.'/'.$file_name)) { ?>
                                    
                                    <button onclick="copyToClipboard4('#p4')" class="btn btn-primary ">Copy FBX file path</button>
                                    <?php } else
                                    {
                                       ?>
                                       <button class="btn btn-primary copy_json error_message">Copy FBX file path</button>
                                       <?php
                                    }  
                                    $file_name =  request()->segment(3).'_'.$csv_counter.'_'.$u_name.'.dwg';
                                    if (file_exists( public_path() . '/'.$sitesettings->dwgfilepath.'/'.$file_name)) { ?>
                                    
                                    <button onclick="copyToClipboard5('#p5')" class="btn btn-primary ">Copy DWG file path</button>
                                    <?php }  else
                                    {
                                       ?>
                                       <button class="btn btn-primary copy_json error_message">Copy DWG file path</button>
                                       <?php
                                    } ?>
                                    @endif
                                 </div>
                                    ...
                                    <div class="col-md-6">
                                       <div class="card ">
                                          <div class="card-header ">
                                             <div class="tree-area">
                                                <div class="panel-body">
                                                   ...
                                                   <div class="alert w-100 m-auto alert-success alert-dismissible fade show"
                                                      role="alert">
                                                   ...
                                                   <div class="row">
                                                      <div class="col-md-12">
                                                         ...
                                                         <p id="error_msg" style="display: none;color:red">Please select same level tree</p>
                                                         <p id="error_msg1" style="display: none;color:red">L0 Floor not be deleted</p>
                                                         <p id="duplicate_error" style="display: none;color:red"></p>
                                                         <ul id="tree1">
                                                            <li class="branch">
                                                               <input type="checkbox" id="tree_id_project_name" value="yes" class="parent_id_s" name="project_name_s"> {{$project_name}}
                                                               <ul>
                                                                  @foreach($categories as $category)
                                                                  <li>
                                                                     <input type="checkbox" id="tree_id_{{ $category->id}}"
                                                                        class="parent_id"
                                                                        name="fav_language[]"
                                                                        value="{{ $category->id}}">
                                                                     {{ $category->title }}
                                          ...
                                          <div class="card-body ">
                                             ...
                                             <div class="row">
                                                <div class="col-md-6">
                                                   <button type="button" <?php if($plot_button=='false') echo  'id="add_plot"' ?>  
                                                      class="btn-sm w3-btn w3-green w3-large btn-block"
                                                      data-toggle="modal" data-target="#exampleModal" <?php if($plot_button=='true') { echo 'disabled="disabled"';} ?>>
                                                   Add Plot
                                                   </button>
                                                   <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addPlotModal">
                                                        Add Plot New
                                                    </button>
                                                </div>
                                                <div class="col-md-6">
                                                   <button <?php if($building_button=='false') echo  'id="addbuilding"' ?>
                                                      class="btn-sm w3-btn w3-green w3-large btn-block" <?php if($building_button=='true') { echo 'disabled="disabled"';} ?>>Add
                                                   Builiding</button>
                                                </div>
                                             </div>
                                             <br>
                                                ...
                                                <div class="col-md-6">
                                                   <button
                                                      class="btn-sm w3-btn w3-indigo w3-large btn-block"
                                                       <?php if($floor_button=='false') echo  'id="addfloor"' ?> <?php if($floor_button=='true') { echo 'disabled="disabled"';} ?>>
                                                   Add Floor
                                                   </button>
                                                </div>
                                                <div class="col-md-6">
                                                    <button
                                                       class="btn-sm w3-btn w3-indigo w3-large btn-block"
                                                         <?php if($room_button=='false') echo  'id="addextroom"' ?> <?php if($room_button=='true') { echo 'disabled="disabled"';} ?>> Add Ext Room</button>
                                                 </div>

                                                <div class="col-md-6 mt-3">
                                                   <button
                                                      class="btn-sm w3-btn w3-indigo w3-large btn-block"
                                                        <?php if($room_button=='false') echo  'id="addroom"' ?> <?php if($room_button=='true') { echo 'disabled="disabled"';} ?>>Add Room</button>
                                                </div>
                                             ...
                                             <div class="row">
                                                ...
                                                @if(file_exists( public_path() . '/'.$sitesettings->fbxfilepath.'/'.$segment_users."_".$csv_counter.'_'.$u_name.'.fbx') || file_exists( public_path() . '/'.$sitesettings->pdffilepath.'/'.$segment_users."_".$csv_counter.'_'.$u_name.'.pdf')  || file_exists( public_path() . '/'.$sitesettings->dwgfilepath.'/'.$segment_users."_".$csv_counter.'_'.$u_name.'.dwg')
                                                )
                                                @else

                                                  @if($project->is_locked=='Yes')
                                                  <div class="  col-md-12 mt-2 underprocess text-center   ">
                                                ...
                                                <div class="col-md-12 bgt-lg d-flex justify-content-center">
                                                   <br>
                                                   <button
                                                      class="btn-sm w3-btn w3-black w3-large btn-block generate_CSV  d-none" <?php if($generate_button=='true') { echo 'disabled="disabled"';} ?>>Generate</button>
                                                   <?php if($generate_button=='true') 
                                                      {
                                                          echo '<p style="color:red;text-align:center">Number of try count complete</p>';
                                                      }
                                                      ?>
                           <i class="fa fa-cog border border-danger bg-danger  text-white rounded-circle roundicon" ></i>
                                                <label class="switch mt-3 mx-3">
                                                   
                                                    <input  class="togglecheckbox" type="checkbox" data-toggle="switch"
                                                     @if($project->is_locked=='No') checked="" @endif 
                                                     data-on-color="primary" data-off-color="primary"><span class="toggle"></span>
                                                </label>
                                                <i class="fa fa-pencil border border-success bg-success text-white rounded-circle roundicon" ></i>
                                                </div>
                                             </div>
                                          </div>
                                       </div>
                                    ...
                                    <div class="col-md-6 rightside">
                                       <!-- <div class="w3-container right-content" id="plot_model" style="display: none;">
                                            <div class="w3-center">
                                             <br>
                                        ...
                                        <div id="floor_model"  style="display: none;border: 1px solid #ccc;padding: 16px;">
                                              <div >
                                                    <div class="w3-center">
                                                         <br>
                                                  ...
                                                  <form method="POST" action="{{ route('admin.add.floor') }}" enctype="multipart/form-data"
                                                     ...
                                                     @csrf
                                                           ...
                                                           <div class="w3-row">
                                                              <input type="hidden" name="building_parent_id_val" id="building_parent_id_val" value="" >
                                                              <!-- <div class="w3-col s6 w3-center" style="width:40%" >
                                                                 <p>Obejct ID</p>
                                                                 </div>
                                                           ...
                                                           <div class="w3-col s6 w3-center"
                                                              ...
                                                              <button style="margin: 0px 20px;" type="submit" class="w3-btn w3-green" id="add_floor"> Add
                                                              Floor</button>
                                                              @if($sitesettings->basebutton=='show')
                                                                <button style="margin: 0px 20px;" type="submit" class="w3-btn w3-green" id="add_basement"> Add
                                                              Basement</button>
                                                              @endif
                                                              <button style="margin: 8px 20px;" type="submit" class="w3-btn w3-green" id="add_roof"> Add
                                                                 Roof</button>
                                                           </div>
                                                           <input type="hidden" id="floor_type" name="floor_type" value="">
                                                           ...
                                                           <?php 
                                                              ...
                                                              ?>
                                                           <br> <input type="hidden" name="project_id" value="<?php echo request()->segment(3); ?>"> <?php ?>
                                                           <input type="hidden" id="project_revision_id" name="project_revision_id" value="<?php echo request()->segment(4); ?>">
                                        ...
                                        <div id="room_model" style="display: none;border: 1px solid #ccc;padding: 16px;">
                                            <div >
                                               <div class="w3-center">
                                                  <br>
                                               ...
                                               <form role="form" id="room_clear" class="room_clear" method="POST"
                                                  ...
                                                  @csrf
                                                  <input type="hidden" name="project_id" id="project_id_room_wpr" value="<?php echo request()->segment(3); ?>" />
                                                  <div class="w3-container">
                                                     <div class="w3-section">
                                                        ...
                                                        <div>
                                                           ...
                                                           <div class="w3-col s6 w3-center"
                                                              ...
                                                              <input type="number" name="number_of_room" value="1" name="" id="number_of_room" style="width:70%">
                                                           </div>
                                                        </div>
                                                        <div class="w3-col s6 w3-center" style="width:40%">
                                                        ...
                                                        <div class="w3-col s6 w3-center radio_plot_floor d-none" style="width:40%">
                                                           <label><b>Floor   </b></label>
                                                        </div>
                                                        <div class="w3-col s6 mb-3 radio_plot_floor  d-none" style="width: 40%;position: relative;left: 46px;">
                                                           <label for="floor_label" class="floor_label">Floor</label> <input type="radio" id="floor_label" name="floorPlot" class="mr-2" value="floor" checked style="">
                                                           <label for="plot_label">Plot</label> <input type="radio" id="plot_label" name="floorPlot" class="" value="building" style="">
                                                        </div>
                                                        ...
                                                        <div id="hide_floor "  >
                                                           ...
                                                           <div class="w3-col s6 w3-center" style="width: 40%;position: relative;left: 46px;">
                                                              <div id="floor_wpr1">
                                                                 ...
                                                                 <select id="parent_id" name="parent_id1" class="w3-input w3-border w3-margin-bottom floor_add_select_id f1" >
                                                              ...
                                                              <div id="Plot_wpr" style="display:none">
                                                                 ...
                                                                 <select id="newid" name="plot_parent" class="w3-input w3-border w3-margin-bottom plot_add_select_id p1" required>
                                                        ...
                                                        <div class="w3-col s6 w3-center" style="width: 40%;position: relative;left: 46px;">
                                                           ...
                                                           <div class="multiselect">
                                                               <div class="selectBox" onclick="showCheckboxes()">
                                                                 <select multiple id="roomlist" name="floor_room[]">
                                                        ...
                                                        <?php 
                                                           ...
                                                           ?><br> 
                                                        <input type="hidden" id="project_revision_id" name="project_revision_id" value="<?php echo request()->segment(4); ?>">
                                                        <input type="hidden" name="project_id" value="<?php echo request()->segment(3); ?>"> <?php
                                                           ?>
                                                        <div class="w3-col s6 w3-center" style="width:40%">
                                                        ...
                                                        <div class="w3-col s6 w3-center w3-green" style="width: 40%;position: relative;left: 38px;">
                                                           ...
                                                           <button type="button" class="w3-btn w3-btn-block w3-red" id="cancel_btn">Cancel</button>
                                                           </a>
                                                        </div>
                                                     ...
                                                     <div class="w3-col s6 w3-center w3-green" style="width: 40%;position: relative;left: 46px;">
                                                        ...
                                                        <!--<a href="#close-modal" rel="modal:close">-->
                                                        <button type="button" class="w3-btn w3-green" id="update_room" style='display:none'> Update Room </button>
                                                        <!--</a>-->
                                                     </div>
                                                     <div class="w3-container w3-padding-hor-16 ">
                                       ...
                                       <div id="extroom_model" style="display: none;border: 1px solid #ccc;padding: 16px;">
                                        <div >
                                           <div class="w3-center">
                                              <br>
                                           ...
                                           <div id="auto_generated_id_extroom" style="display:none;">
                                              ...
                                              <div class="w3-col s6 w3-center" style="width: 40%;position: relative;left: 46px;">
                                                 <div class="form-group {{ $errors->has('id') ? 'has-error' : '' }}">
                                                    <input class="form-control" type="number" name="id" required="" id='extroom_id'
                                                       disabled>
                                                 </div>
                                              </div>
                                           </div>
                                           ...
                                           <form role="form" id="extroom_clear" class="extroom_clear" method="POST"
                                              action="{{ route('admin.add.extroom') }}" enctype="multipart/form-data">
                                              @csrf
                                              <input type="hidden" name="project_id" id="project_id_extroom_wpr" value="<?php echo request()->segment(3); ?>" />
                                              <div class="w3-container">
                                                 <div class="w3-section">
                                                    <div class="w3-row">
                                                       <!-- <div class="w3-col s6 w3-center" style="width:40%" >
                                                    ...
                                                    <div>
                                                       ...
                                                       <div class="w3-col s6 w3-center"
                                                          style="width: 40%;position: relative;left: 46px;">
                                                          <input type="text" id="extroom_title" name="title"
                                                             value="extroom"
                                                             class="w3-input w3-border w3-margin-bottom"
                                                             placeholder="Enter extroom Name" required="">
                                                          @if ($errors->has('title'))
                                                          <span class="text-red" role="alert">
                                                          <strong>{{ $errors->first('title') }}</strong>
                                                          </span>
                                                       ...
                                                       <div class="w3-col s6 w3-center"
                                                          style="width: 15%;position: relative;left: 46px;">
                                                          <input type="number" name="number_of_extroom" value="1" name="" id="number_of_extroom" style="width:70%">
                                                       </div>
                                                    </div>
                                                    <div class="w3-col s6 w3-center" style="width:40%">
                                                    ...
                                                    <div class="w3-col s6 w3-center"
                                                       style="width: 40%;position: relative;left: 46px;">
                                                       <select id="extroom_type" name="extroom_type"
                                                    ...
                                                    <div class="w3-col s6 mb-3 radio_plot_floor d-none" style="width: 40%;position: relative;left: 46px;">
                                                       ...
                                                       <label for="plot_label">Plot</label> <input type="radio" id="plot_label" name="floorPlot" class="" value="building"  checked style="">
                                                    </div>
                                                    <div id="hide_floor " >
                                                       <div class="w3-col s6 w3-center" style="width:40%">
                                                       ...
                                                       <div class="w3-col s6 w3-center" style="width: 40%;position: relative;left: 46px;">
                                                          <div id="floor_wpr1" style="display:none">
                                                             <div class="hidde_check">
                                                          ...
                                                          <div id="Plot_wprextroom" style="display: block" >
                                                             <div class="hidde_check"></div>
                                                             <select id="newid" name="plot_parent" class="w3-input w3-border w3-margin-bottom plot_add_select_idext p1" required>
                                                                <!--<option value="">Select Plot</option>-->
                                                                @foreach($allPlot as $rows)
                                                                <option value="{{ $rows->id }}" >{{ $rows->title }}</option>
                                                                @endforeach
                                                    ...
                                                    <div class="w3-col s6 w3-center" style="width:40%">
                                                       <label><b class="">Proximity extroom</b></label>
                                                    </div>
                                                    <div class="w3-col s6 w3-center" style="width: 40%;position: relative;left: 46px;">
                                                       ...
                                                       <div class="multiselect">
                                                           <div class="selectBox" onclick="showCheckboxes()">
                                                             <select multiple id="extroomlist" name="floor_extroom[]">
                                                    ...
                                                    <div class="w3-col s6 w3-center"
                                                       style="width: 40%;position: relative;left: 46px;">
                                                       <input class="w3-input w3-border w3-margin-bottom" type="text"
                                                          placeholder="Enter Area" name="extroom_area" id="extroom_area" value="">
                                                    </div>
                                                    <input type="hidden" id="floor_id" value="">
                                                    <div class="w3-col s6 w3-center w3-green" style="width: 40%;position: relative;left: 38px;">
                                                       <a href="#close-modal" rel="modal:close">
                                                    ...
                                                    <input type="hidden" id="extroom_parent_id" value="">
                                                 </div>
                                                 <div class="w3-col s6 w3-center w3-green" style="width: 40%;position: relative;left: 46px;">
                                                    <button type="submit" class="w3-btn w3-green" id="submit_extroom"> Create extroom</button>
                                                    <!--<a href="#close-modal" rel="modal:close">-->
                                                    <button type="button" class="w3-btn w3-green" id="update_extroom" style='display:none'> Update extroom </button>
                                                    <!--</a>-->
                                                 </div>
                                                 <div class="w3-container w3-padding-hor-16 ">
                                                    <input type="hidden" id="extroom_child_val" value="">
                                               </div>
                                           </div>
                                           </form>
                                        </div>
                                                ...
                                                <form role="form" id="room_clear" class="room_clear" method="POST"
                                                   ...
                                                   <div class="w3-container">
                                                      <div class="w3-section">
                                                         ...
                                                         <div class="w3-col s6 mb-3 radio_plot_floor" style="width: 40%;position: relative;left: 46px;">
                                                            <label for="floor_label" class="floor_label">Floor</label> <input type="radio" id="floor_label" name="floorPlot" class="mr-2" value="floor" checked style="">
                                                            <label for="plot_label">Plot</label> <input type="radio" id="plot_label" name="floorPlot" class="" value="building" style="">
                                                         </div>
                                                         <div id="hide_floor">
                                        ...
                                        <div id="project-edit-modal" style="display: none;border: 1px solid #ccc;padding: 16px;">
                                             <div >
                                                <div >
                                                      <h1 class="text-center"> Edit Project</h1>
                                                   </div>
                                                <form role="form" id="category" method="POST" action="{{ route('admin.update.Projectupdate') }}" enctype="multipart/form-data">
                                                   @csrf
                                                   <div >
                                                      <div style="width: 85%;margin:20px auto;">
                                                         <label><b>Project Name</b></label>
                                                         <div class="form-group {{ $errors->has('title') ? 'has-error' : '' }}">
                                                            <input class="form-control" type="text" name="project_name" placeholder="Create Project" required="" id="get_project_name">
                                                         </div>
                                                         <input type="hidden" name="id" id="get_project_id">
                                                         <br>
                                                         <label><b>Location</b></label>
                                                         <div class="form-group {{ $errors->has('title') ? 'has-error' : '' }}">
                                                            <input class="form-control" type="text" name="location" placeholder="Location" required="" id="get_location">
                                                         </div>
                                                         <br>
                                                         <label><b>Current Revision</b></label>
                                                         <div class="form-group {{ $errors->has('title') ? 'has-error' : '' }}">
                                                            <input class="form-control" type="text" name="current_revision" placeholder="Current Revision" required="" id="get_current_revision">
                                                         </div>
                                                         <br>
                                                         <label><b>Project Description</b></label>
                                                         <div class="form-group {{ $errors->has('title') ? 'has-error' : '' }}">
                                                            <textarea maxlength="702" class="form-control" type="text" name="description" id="get_description" placeholder="you can write upto 700 characters" required=""  rows="6" cols="50"></textarea>
                                                         </div>
                                                         <!-- <div class="w3-col s6 w3-center w3-green" style="width: 48%;position: relative;"> -->
                                                         <button type="button" id="close" class="btn btn-danger w3-btn-block" data-dismiss="modal" style="width: 48%;position: relative;">Close</button>
                                                         <!-- </div> -->
                                                         <button  class="w3-btn w3-green" id="create_project"  style="width: 48%;position: relative;left:20px;">  Update Project</button>
             ...
             <div class="w3-modal-content w3-card-8 w3-animate-zoom" style="max-width:600px">
                ...
                <div class="w3-container">
                   <div class="w3-section">
                      ...
                      <div class="w3-col s6 w3-center w3-green" style="width: 40%;position: relative;left: 46px;">
                         <!-- <button  type="submit"  class="w3-btn w3-green" id="submit_floor">  view Button</button> -->
                         <button type="button" class="w3-btn w3-green" id="delete_tree_project"> Delete Tree </button>
                      </div>
                      <div class="w3-container w3-padding-hor-16 ">
                      </div>
                   </div>
  ...
  <div class="modal-dialog" role="document">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <input type="text" id="rename-text" name="file_name" value="" class="form-control">
      </div>
      ...
      <!-- Modal -->
      <div class="modal fade" id="addPlotModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
                        ...
                        <div class="w3-section">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="row">
                                        <div class="col-md-5">
                                            <span class="text-nowrap"><b>Width</b></span></div>
                                        <div class="col-md-7">
                                            <input class="form-control w3-margin-bottom" name="width" type="number"
                                            placeholder="Enter Width" id="width" value="" step="any">
                                        </div>
                                    </div>

                                    <div class="row">
                                        <div class="col-md-5">
                                            <span class="text-nowrap"><b>Length</b></span></div>
                                        <div class="col-md-7">
                                            <input class="form-control w3-margin-bottom" name="length" type="number" 
                                            placeholder="Enter Length" id="length" value="" step="any">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-5">
                                            <span class="text-nowrap"><b>Height limit</b></span></div>
                                        <div class="col-md-7">
                                            <input class="form-control w3-margin-bottom" name="height" type="number"
                                            placeholder="Enter Height" id="height" value="" step="any">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <span>Total Floor Area: 213425</span>
                                    </div>
                                </div>
                            </div>
                            <!-- <div class="w3-col s6 w3-center" style="width:40%">
                            ...
                            <?php 
                                ...
                                ?><br> <input type="hidden" id="pro_id" name="project_id" value="<?php echo request()->segment(3); ?>">
                            <input type="hidden" id="project_revision_id" name="project_revision_id" value="<?php echo request()->segment(4); ?>">
                            <?php
                                ?>         
                            <input type="hidden" id="plot_id" value="">
                            <div class="w3-col s6 w3-center w3-green" style="width: 40%;position: relative;left: 38px;">
                                <a href="javascript:void(0)" class="w3-btn w3-btn-block w3-red"> 
                                Cancel</a>
                            </div>
                            <div class="w3-col s6 w3-center w3-green" style="width: 40%;position: relative;left: 46px;"
                                id="submit_form">
                    ...
                    <div id="show_building" style="border: 1px solid #ccc;padding: 16px;">
                    <div class="">
                       <div class="w3-center">
                          <br>
                          ...
                          <div class="w3-container">
                             ...
                             <input class="form-control w3-margin-bottom" type="number" name="floor_height"
                                placeholder="Floor Height" id="floor_height" value="" step="any">
                             </div>
                             <div class="w3-col s6 w3-center" style="width:40%">
                             ...
                             <input class="form-control w3-margin-bottom" type="number" name="number_of_floor"
                                placeholder="Number Of Floor" id="number_of_floor" value="" step="any">
                             </div>
                             <div class="w3-col s6 w3-center" style="width:40%">
                             ...
                             <input class="form-control w3-margin-bottom" type="number" name="target_area"
                                placeholder="Target Area" id="target_area" value="" step="any">
                             </div>
                             <input type="hidden" id="plot_idss" value="">
                             <div class="w3-col s6 w3-center w3-green" style="width: 40%;position: relative;left: 38px;">
                             <a href="#close-modal" rel="modal:close"><button type="button" class="w3-btn w3-btn-block w3-red"
...
<script type="text/javascript">
   ...
   function floorIsSelected(){
       ...
       $('#floor_wpr .hidde_check').append("<input type='hidden' name='flotFlor_check' class='flotFlor_check' value='f' />");
       $('.f1').show();
   ...
   // plot selected and floor deselected
     function plotIsSelected(){
      ...
      $('.f1').hide();
         ...
         $('#Plot_wpr .hidde_check').append("<input type='hidden' name='flotFlor_check' class='flotFlor_check' value='p' />");
         $('#Plot_wprextroom .hidde_check').append("<input type='hidden' name='flotFlor_check' class='flotFlor_check' value='p' />");
       ...
       if (plot_parent_id) {
        ...
        //  $('#show_floor').show();
         ...
         $.ajax({
             ...
             type: 'GET',
             data: {
                 'room_child_val': room_child_val,project_id:project_id,project_revision:project_revision,select_radio:select_radio
             },
             success: function(data) {
                ...
                //alert(room_child_val);
                         ...
                         if(val.family == "Plot"){
                             ...
                             if (val.id == room_child_val) {
                              //console.log(val.title)
                                 $dropdowns3.append($("<option selected />").val(val.id).text(val.title));
                                 plotSelectedPRoom(val.id,select_radio);
                             } else {
                                 $dropdowns3.append($("<option />").val(val.id).text(val.title));
                             }
                            ...
                            // if (val.title == data.floor_data[0].title) {
                              if (val.id == room_child_val) {
                                 $dropdowns2.append($("<option selected />").val(val.id).text(val.title));
                                  plotSelectedFRoom(val.id,select_radio);
                             } else {
                                 $dropdowns2.append($("<option />").val(val.id).text(val.title));
                             }
                         }
                     }
                 ...
                 $.each(data.floorRecord, function(recordKey,recordVal){
                     ...
                     if(recordVal.project_id == project_id && data.roomRecord.parent_host == 'Plot'){
 
                         if(recordVal.family == "Floor"){
                             if (recordVal.title) {
                                 $dropdowns2.append($("<option selected />").val(recordVal.id).text(recordVal.title));
                             } else {
                                 $dropdowns2.append($("<option />").val(recordVal.id).text(recordVal.title));
                             }
                         }
                     }
                 })
           ...
           success: function(data) {
               ...
               $.each(data.roomType, function(key, val) {
                   if(val.type=='external'){
                        ...
                        $dropdowns.append($("<option selected/>").val(val.room_type).text(val
                            .room_type));
                    } else {
                        $dropdowns.append($("<option />").val(val.room_type).text(val
                            .room_type));
                    }
