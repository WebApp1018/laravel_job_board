...
<body>
    ...
    <header class="bg-gray">
        ...
        <div class="header-right">
            @if($settings->viewblogs=='show')   <a href="{{ route('latestblog') }}" class="header-navlink text-dark">Blogs</a> @endif
    ...
    <footer class="pt-5">
        ...
        <div class="container">
            ...
            <p class="mb-0"><img src=" {{ asset('vergecad/assets/icons/tick.png') }}" alt=""> Business center 1, The Meydan Hotel, Nad Al Sheba Road, Dubai, U.A.E.</p>
            <p><img src=" {{ asset('vergecad/assets/icons/mail.png') }}" alt=""> info@vergecad.com</p>
        </div>
